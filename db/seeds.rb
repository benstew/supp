...
products = Product.create([{ name: 'Whey Protein', description: 'A whey based protein', price: 29.99 , serving_size: 20 , product_size: 2, family: 'Protein', goal_id: 2 },
  { name: 'Casein Protein', description: 'A casein based protein', price: 39.99 , serving_size: 20 , product_size: 2 , family: 'Protein', goal_id: 2 },
  ...
  { name: 'Fish Oil', description: 'A fish oil based supplement', price:7.99 , serving_size:10 , product_size:1 , family: 'Omegas', goal_id:7 },
  { name: 'Multi Vitamin', description: 'A multivitamin', price: 14.99 , serving_size:10 , product_size:1 , family: 'Vitamin', goal_id:3 }
])
